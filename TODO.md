...
- [ ] **Fraunhofer Lines (Solar Spectroscope)** — Replaces the planned "Hydrogen Spectrum / Spectroscope". Solar continuous spectrum with real Fraunhofer absorption lines (H Balmer, Na D, Ca H&K, Mg b, Fe, …) overlaid; line-matching game where the student toggles candidate elements and identifies which ones are in the photosphere. The Bohr-hydrogen sim already covers single-atom emission/absorption mechanism; this one is purely spectroscopy as chemical fingerprinting.
